...
Covariates_Female$h_m_race <- as.factor(Covariates_Female$h_m_race)
Covariates_Female$h_m_enroll_educ <- as.factor(Covariates_Female$h_m_enroll_educ)
Covariates_Female$batches <- as.factor(Covariates_Female$batches)
Covariates_Female$cg_labor_type <- as.factor(Covariates_Female$cg_labor_type)
Covariates_Female$h_del_method <- as.factor(Covariates_Female$h_del_method)
Covariates_Female$h_m_alcohol_prenatal <- as.factor(Covariates_Female$h_m_alcohol_prenatal)
Covariates_Female$Smoking_Composite <- as.factor(Covariates_Female$Smoking_Composite)
Covariates_Female$h_firstborn <- as.factor(Covariates_Female$h_firstborn)
```
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_dep) 
  
  UnadjustedLM_Results_DEP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_DEP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_DEP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_DEP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_DEP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_DEP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_dep
                  +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
                   +Covariates_Female$h_m_enroll_educ
                   +Covariates_Female$batches
                   +Covariates_Female$cg_labor_type
                   +Covariates_Female$h_del_method
                   +Covariates_Female$h_m_alcohol_prenatal
                   +Covariates_Female$Smoking_Composite
                   +Covariates_Female$h_firstborn
                   +Covariates_Female$h_gravidity)
  
  AdjustedLM_Results_DEP[[i]]<-summary(LM_adjusted)
  names(AdjustedLM_Results_DEP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_DEP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_DEP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_DEP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_DEP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_DEP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_DEP)[i]<-colnames(MEs_Female_reorder)[i]
}
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_dbup_dibp) 
  
  UnadjustedLM_Results_DBUP_DIBP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_DBUP_DIBP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_DBUP_DIBP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_DBUP_DIBP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_DBUP_DIBP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_DBUP_DIBP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_dbup_dibp 
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_DBUP_DIBP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_DBUP_DIBP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_DBUP_DIBP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_DBUP_DIBP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_DBUP_DIBP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_DBUP_DIBP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_DBUP_DIBP)[i]<-colnames(MEs_Female_reorder)[i]
}
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_bcetp) 
  
  UnadjustedLM_Results_BCETP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_BCETP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_BCETP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_BCETP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_BCETP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_BCETP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_bcetp
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_BCETP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_BCETP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_BCETP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_BCETP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_BCETP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_BCETP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_BCETP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_bdcpp) 
  
  UnadjustedLM_Results_BDCPP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_BDCPP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_BDCPP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_BDCPP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_BDCPP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_BDCPP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_bdcpp
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_BDCPP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_BDCPP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_BDCPP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_BDCPP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_BDCPP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_BDCPP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_BDCPP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_dphp) 
  
  UnadjustedLM_Results_DPHP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_DPHP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_DPHP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_DPHP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_DPHP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_DPHP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$log_dphp
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_DPHP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_DPHP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_DPHP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_DPHP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_DPHP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_DPHP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_DPHP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$dprp_lod) 
  
  UnadjustedLM_Results_DPRP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_DPRP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_DPRP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_DPRP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_DPRP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_DPRP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$dprp_lod
                  +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_DPRP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_DPRP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_DPRP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_DPRP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_DPRP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_DPRP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_DPRP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$bboep_lod) 
  
  UnadjustedLM_Results_BBOEP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_BBOEP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_BBOEP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_BBOEP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_BBOEP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_BBOEP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$bboep_lod
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_BBOEP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_BBOEP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_BBOEP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_BBOEP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_BBOEP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_BBOEP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_BBOEP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$behp_lod) 
  
  UnadjustedLM_Results_BEHP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_BEHP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_BEHP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_BEHP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_BEHP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_BEHP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$behp_lod
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_BEHP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_BEHP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_BEHP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_BEHP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_BEHP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_BEHP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_BEHP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$bcpp_lod) 
  
  UnadjustedLM_Results_BCPP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_BCPP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_BCPP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_BCPP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_BCPP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_BCPP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$bcpp_lod
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_BCPP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_BCPP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_BCPP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_BCPP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_BCPP)[i]<-colnames(MEs_Female_reorder)[i]
  
  Adjusted_LM_EE_BCPP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_BCPP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_unadjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$bmpp_lod) 
  
  UnadjustedLM_Results_BMPP[[i]]<-summary(LM_unadjusted)
  names(UnadjustedLM_Results_BMPP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Unadjusted_LM_Pval_BMPP[[i]] <- summary(LM_unadjusted)$coefficients[2,4]
  names(Unadjusted_LM_Pval_BMPP)[i]<-colnames(MEs_Female_reorder)[i]
  
  UnadjustedLM_BMPP_coefficients[[i]] <- broom::tidy(LM_unadjusted)
  names(UnadjustedLM_BMPP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
}
#Printing unadjusted model p-values
...
for(i in 1:dim(MEs_Female_reorder)[2]){
  LM_adjusted<-lm((MEs_Female_reorder[,i])~OPE_Data_Female$bmpp_lod
                   +Covariates_Female$opfr_sg
                   +Covariates_Female$h_m_delivery_age
                   +Covariates_Female$h_m_prepreg_bmi
                   +Covariates_Female$h_m_race
  ...
  names(AdjustedLM_Results_BMPP)[i]<-colnames(MEs_Female_reorder)[i] 
  
  AdjustedLM_BMPP_coefficients[[i]] <- broom::tidy(LM_adjusted)
  names(AdjustedLM_BMPP_coefficients)[i]<-colnames(MEs_Female_reorder)[i] 
  
  Adjusted_LM_Pval_BMPP[[i]] <- summary(LM_adjusted)$coefficients[2,4]
  names(Adjusted_LM_Pval_BMPP)[i]<-colnames(MEs_Female_reorder)[i]
  
   Adjusted_LM_EE_BMPP[[i]] <- summary(LM_adjusted)$coefficients[2,1]
  names(Adjusted_LM_EE_BMPP)[i]<-colnames(MEs_Female_reorder)[i]
}
#Printing adjusted model p-values
...
#Save pval summary
#write.csv(AdjustedLM_Pval_Summary, "/active/paquette_a/slapehn/OPE_and_PlacentalTranscriptome/Results/WGCNA/Female_AdjustedLM_pval_summary_083024.csv")
```
...
#write.csv(AdjustedLM_EE_Summary, "/active/paquette_a/slapehn/OPE_and_PlacentalTranscriptome/Results/WGCNA/Female_AdjustedLM_EE_summary_083024.csv")
```
